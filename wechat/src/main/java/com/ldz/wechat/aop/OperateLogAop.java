...
public class OperateLogAop {
    ...
    @Around("execution(public * com.ldz.wechat..*.*Controller.save*(..))" +
            "|| execution(public * com.ldz.wechat..*.*Controller.update*(..))" +
            "|| execution(public * com.ldz.wechat..*.*Controller.remove*(..))"+
            "|| execution(public * com.ldz.wechat..*.*Ctrl.save*(..))" +
            "|| execution(public * com.ldz.wechat..*.*Ctrl.update*(..))" +
            "|| execution(public * com.ldz.wechat..*.*Ctrl.remove*(..))"
    )
...
//            HttpServletRequest request
            SysYh userInfo = WxBaseController.getBossCurrentUser(true);
            if(userInfo != null){
              log.setCzr(userInfo.getYhid()+"-"+userInfo.getXm());
            }
//            CoachManagement coachManagement = WxBaseController.getCoachCurrentUser(false);
//            if(coachManagement != null){
//                log.setCzr(coachManagement.getId()+"-"+coachManagement.getCoachName());
//            }
