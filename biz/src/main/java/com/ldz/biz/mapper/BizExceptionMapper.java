...
public interface BizExceptionMapper extends Mapper<BizException> {
	...
	@Select("SELECT SUM( CASE WHEN info_check_status = '00' THEN 1 ELSE 0 END ) 'BMDSH', "
			...
			+ "SUM( CASE WHEN  (fir_sub_test_time != ''  AND  (fir_sub_payment_time is null or fir_sub_payment_time = '' )) THEN 1 ELSE 0 END ) 'KM1JF', "
			...
			+ "SUM( CASE WHEN (sec_sub_test_time != ''  AND  (sec_sub_payment_time is null or sec_sub_payment_time = '' )) THEN 1 ELSE 0 END ) 'KM2JF', "
			...
			+ "SUM( CASE WHEN (third_sub_test_time != ''  AND  (third_sub_payment_time is null or third_sub_payment_time = '' )) THEN 1 ELSE 0 END ) 'KM3JF', "
