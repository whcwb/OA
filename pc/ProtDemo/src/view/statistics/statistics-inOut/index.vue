  ...
  <div class="box_col">
      ...
      <Row>
        <Col span="5">
          ...
          <DatePicker  type="daterange" split-panels @on-change="getNf" clearable @on-clear="getNf"  placeholder="请选择日期（默认当天）" style="width: 250px"></DatePicker>
        </Col>
      <Col span="4">
    ...
    <Row class="tjsize">
      <Col span="5">
        <Tag color="success">合计金额</Tag>  {{this.tjzje}}元
      </Col>
      <Col>
        <Tag color="warning">总人数</Tag>   {{data1.length}}人
      </Col>
    </Row>
  </div>
</template>
