<template>
  <div class="box_col">
    ...
    <Row v-if="!titShow">
      <Col span="24">
        <pager-tit title="变更车型"></pager-tit>
      </Col>
      <Col span="24">
        ...
        <Col span="24">
          <Card dis-hover>
            ...
            <span style="float: left">
              ...
              <span v-if="titShow">变更<span style="color: #ff005c">车</span>型_</span>
              学员信息
            </span>
                  ...
                  <Col span="24">
                    ...
                    <Row>
                      ...
                      <Col span="4" v-if="carTypC == false && stuMes.id!=''">
                        <FormItem>
                          <Button type="info" @click="carTypC=true">变更车型</Button>
                        </FormItem>
                      </Col>
                    </Row>
                    <Row v-if="carTypC">
                        ...
                        <Row>
                          <Col span="4">
                            <FormItem prop="carType">
                              <Select v-model="C_param.carType" clearable placeholder="车型选择" filterable>
    ...
    methods: {
      okCarTyp(name,mess){
        ...
        this.$refs[name].validate((valid) => {
          if (valid) {
            if(v.C_param.carType == v.stuMes.carType ){
              v.swal({
                type:'warning',
                title:'变更车型与当前车型一致',
              })
              ...
              this.$http.post('/api/traineeinformation/editCarType',v.C_param).then(res=>{
                if(res.code == 200){
