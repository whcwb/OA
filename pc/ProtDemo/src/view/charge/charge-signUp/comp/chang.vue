<template>
  <div>
    <Modal v-model="showModal"
      ...
      <Row>
        <Col span="24">
          <Input :number="true" v-model="price" placeholder="请输入优惠金额" ></Input>
        </Col>
      </Row>
      <div slot="footer">
  ...
  export default {
    ...
    methods: {
      ...
      submit(){
        ...
        this.$http.post('/api/traineeinformation/editReduceAndRealPay', {traineeId :this.userAudit.id,
          reduceId:this.reduceCode,
          chargeId:chargeId,
