  ...
  <div>
    <Form ref="userForm" :label-width="10" :model="user" :rules="userRules">
      <Row>
        <Col span="24">
          <Card dis-hover>
            <!--<Row solt="title" style="padding-bottom: 10px" type="flex" align="top" justify="end">-->
            <!--<Col span="12" push="1" style="text-align: right">-->
            ...
            <Row>
              <Col span="4" style="text-align: center" >
                ...
                <!--<img v-else :src="headImg" width="100%"/>-->
                <!--</Col>-->
                <!--</Row>-->
                <!--<Row type="flex" justify="center" style="padding-top: 5px">-->
                <!--<Col span="12" align="right">-->
                <!--<Tooltip content="打开摄像头">-->
                <!--<Button type="info" shape="circle" @click="openCamera(1)" icon="ios-camera"></Button>-->
                <!--</Tooltip>-->
                <!--</Col>-->
                <!--<Col span="12" align="left">-->
                <!--<Tooltip content="拍照">-->
                <!--<Button type="info" shape="circle" icon="ios-aperture"-->
                <!--:disabled="!camSdkPreview"-->
                ...
                <!--<Row>-->
                <!--<Col span="24">-->
                <!--<img v-if="cardFrontFile == null" src="@/assets/images/card_front.png" width="100%"/>-->
                <!--<img v-else ref="cardFrontImg" width="100%"/>-->
                <!--</Col>-->
                <!--</Row>-->
                <!--<Row type="flex" justify="center" style="padding-top: 5px">-->
                <!--&lt;!&ndash;<Col span="4">-->
                <!--<Tooltip content="打开摄像头">-->
                <!--<Button type="info" shape="circle" @click="openCamera(0)" icon="ios-camera"></Button>-->
                <!--</Tooltip>-->
                <!--</Col>&ndash;&gt;-->
                <!--<Col span="4">-->
                <!--<Tooltip content="拍照">-->
                <!--<Button type="info" shape="circle" icon="ios-aperture"-->
                <!--:disabled="!camSdkPreview"-->
                <!--@click="captureCardFront"></Button>-->
                <!--</Tooltip>-->
                <!--</Col>-->
                <!--</Row>-->
                <!--<Row>-->
                <!--<Col span="24">-->
                <!--<img v-if="cardBackFile == null" src="@/assets/images/card_back.png" width="100%"/>-->
                <!--<img v-else ref="cardBackImg" width="100%"/>-->
                <!--</Col>-->
                <!--</Row>-->
                <!--<Row type="flex" justify="center" style="padding-top: 5px">-->
                <!--<Col span="4">-->
                ...
                <Row>
                  <Col span="3">
                    <FormItem prop="jgdm">   <!-- prop="jgdm"--> <!--v-model="fullJgdmPath"-->
                      ...
                      <!--<Cascader trigger="hover" :clearable="false" @on-change="bmdChange" v-model="fullJgdmPath" :data="dictList.bmd.data"-->
                      <!--placeholder="报名点选择(必填)" filterable></Cascader>-->
                    </FormItem>
                  </Col>
                  <Col span="3">
                    <FormItem >
                  ...
                  <!--v-show="user.carType.substring(0,1) != 'C'"-->
                  <Col span="2" :sm="3">
                ...
                <Row>
                  <Col span="6">
                    ...
                    <Row v-else-if="LO=='local'">
                      <Col span="24">
                        <FormItem>
                          <Select v-model="tjr" placeholder="推荐人" not-found-text="暂无信息" label-in-value
      ...
      <!--<Row style="padding-top: 10px" type="flex" justify="end">-->
      <!--<Col span="4" push="1">-->
      <!--<Button type="default" icon="md-refresh" style="font-size: 18px" @click="initPage">重置</Button>-->
      <!--&nbsp;-->
      <!--<Button type="success" icon="md-checkmark-circle-outline" style="font-size: 18px" @click="submit('userForm')">-->
